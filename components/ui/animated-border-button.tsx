...
const buttonRootVariants = cva(
  "inline-flex items-center cursor-pointer justify-center gap-2 whitespace-nowrap rounded-lg font-medium motion-micro focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        primary: "text-white",
    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          className,
          showAnimatedBorder && mode === "animatedBorder" && "border-none",
        )}
        {...props}
      >
...
Root.displayName = "AnimatedBorderButtonRoot";
...
function Icon<T extends ElementType = "span">({
  as,
  className,
  size,
  ...props
...
export { Root, Icon, buttonRootVariants, buttonIconVariants };
export type { ButtonRootProps, AnimatedBorderProps };
